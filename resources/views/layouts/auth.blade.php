...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description" content="MedMonkey admin is super flexible, powerful, clean &amp; modern responsive bootstrap 4 admin template with unlimited possibilities.">
        <meta name="keywords" content="admin template, MedMonkey admin template, dashboard template, flat admin template, responsive admin template, web app">
                    ...
                    <div class="auth-wrapper auth-cover">
                        <div class="auth-inner row m-0">
                            ...
                            <a class="brand-logo" href="index.html">
                                ...
                                <h2 class="brand-text text-primary ms-1">MedMonkey</h2>
                            </a>
                            <!-- /Brand logo-->
                            <!-- Left Text-->
