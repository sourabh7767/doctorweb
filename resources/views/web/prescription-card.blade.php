...
<div class="cardArea">
    ...
    <div class="d-flex align-items-center">
        <span class="editModal remove removed" data-id="{{@$Prescription->id}}" data-bs-toggle="modal" data-bs-target="#editPrescription" ><i class="las la-pen"></i></span><span class="crossValue removed remove"><i class="las la-times"></i></span>
    </div>
